...
(defn guest-str2-result [a b] (str a b))
(defn guest-str2-length [a b] (.length ^String (str a b)))
(defn guest-str3-result [a b c] (str a b c))
(defn guest-str3-length [a b c] (.length ^String (str a b c)))
(defn guest-str2-named-result [a b] (str a b))
(defn guest-str3-mixed-result [a b c] (str a b c))
