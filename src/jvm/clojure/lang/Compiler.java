 ...
 * overload.
 * <p>
 * Casts and primitive array constructors carry {@code :checked-method} as well. Those always
 * rewrite (matching stock {@code :inline}): with the flag false they use {@code :checked-method},
 * with it truthy they use {@code :method}. Without {@code :checked-method}, rewrite only happens
 * while the flag is truthy. {@code :fold} folds left pairwise the way variadic operations do.
...
/** Validates macro form against spec when {@link RT#CHECK_SPECS} is enabled (after core bootstrap). */
