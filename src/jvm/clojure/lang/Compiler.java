...
public static class FISupport {
	...
	public static java.lang.reflect.Method maybeFIMethod(Class target) {
		return CompilerFI.maybeFIMethod(target);
	}

	static boolean maybeEmitFIAdapter(ObjExpr objx, GeneratorAdapter gen, Expr expr, Class targetClass) {
		return CompilerFI.maybeEmitFIAdapter(objx, gen, expr, targetClass);
	}
	...
	static void emitInvokeDynamicAdapter(GeneratorAdapter gen,
		...
		CompilerFI.emitInvokeDynamicAdapter(gen, targetClass, targetMethod, implClass, implMethod);
	}
}
