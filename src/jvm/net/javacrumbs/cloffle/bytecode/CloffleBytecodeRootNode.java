...
public static final class ThrowArityException {
    ...
    /**
     * Direct-linking: call a compile-time-pinned IFn/ClojureClosure with no Var lookup
     * and no root assumption — {@code with-redefs} does not affect this site.
     */
    @Operation(storeBytecodeIndex = true)
    @com.oracle.truffle.api.bytecode.ConstantOperand(type = Object.class, name = "fn")
    public static final class InvokePinned0 {
        @Specialization(guards = "isClojureClosure(fn)")
        public static Object doClojureClosure(
                Object fn,
                @com.oracle.truffle.api.dsl.Cached(value = "createCallNode(asClojureClosure(fn))", neverDefault = true)
                        DirectCallNode callNode) {
            ClojureClosure cc = asClojureClosure(fn);
            return BytecodeInvoke.callDirect(callNode, new Object[]{cc.getCapturedFrame()});
        }

        @Specialization(guards = "isPlainIFn(fn)")
        public static Object doIFn(Object fn) {
            return BytecodeInvoke.invokeIFn((IFn) fn);
        }

        @Specialization(replaces = {"doClojureClosure", "doIFn"})
        public static Object doOther(Object fn) {
            return BytecodeInvoke.cannotCall(fn);
        }

        @Idempotent
        protected static boolean isClojureClosure(Object fn) {
            return fn instanceof ClojureClosure;
        }

        @Idempotent
        protected static boolean isPlainIFn(Object fn) {
            return fn instanceof IFn && !(fn instanceof ClojureClosure);
        }

        protected static ClojureClosure asClojureClosure(Object fn) {
            return (ClojureClosure) fn;
        }
    ...
    @Operation(storeBytecodeIndex = true)
    @com.oracle.truffle.api.bytecode.ConstantOperand(type = Object.class, name = "fn")
    public static final class InvokePinned1 {
        @Specialization(guards = "isClojureClosure(fn)")
        public static Object doClojureClosure(
                Object fn,
                Object a0,
                @com.oracle.truffle.api.dsl.Cached(value = "createCallNode(asClojureClosure(fn))", neverDefault = true)
                        DirectCallNode callNode) {
            ClojureClosure cc = asClojureClosure(fn);
            return BytecodeInvoke.callDirect(callNode, new Object[]{cc.getCapturedFrame(), a0});
        }

        @Specialization(guards = "isPlainIFn(fn)")
        public static Object doIFn(Object fn, Object a0) {
            return BytecodeInvoke.invokeIFn((IFn) fn, a0);
        }

        @Specialization(replaces = {"doClojureClosure", "doIFn"})
        public static Object doOther(Object fn, Object a0) {
            return BytecodeInvoke.cannotCall(fn);
        }
    ...
    @Operation(storeBytecodeIndex = true)
    @com.oracle.truffle.api.bytecode.ConstantOperand(type = Object.class, name = "fn")
    public static final class InvokePinned2 {
        @Specialization(guards = "isClojureClosure(fn)")
        public static Object doClojureClosure(
                Object fn,
                Object a0,
                ...
                @com.oracle.truffle.api.dsl.Cached(value = "createCallNode(asClojureClosure(fn))", neverDefault = true)
                        DirectCallNode callNode) {
            ClojureClosure cc = asClojureClosure(fn);
            return BytecodeInvoke.callDirect(callNode, new Object[]{cc.getCapturedFrame(), a0, a1});
        }

        @Specialization(guards = "isPlainIFn(fn)")
        public static Object doIFn(Object fn, Object a0, Object a1) {
            return BytecodeInvoke.invokeIFn((IFn) fn, a0, a1);
        }

        @Specialization(replaces = {"doClojureClosure", "doIFn"})
        public static Object doOther(Object fn, Object a0, Object a1) {
            return BytecodeInvoke.cannotCall(fn);
        }
    ...
    @Operation(storeBytecodeIndex = true)
    @com.oracle.truffle.api.bytecode.ConstantOperand(type = Object.class, name = "fn")
    public static final class InvokePinned3 {
        @Specialization(guards = "isClojureClosure(fn)")
        public static Object doClojureClosure(
                Object fn,
                Object a0,
                ...
                @com.oracle.truffle.api.dsl.Cached(value = "createCallNode(asClojureClosure(fn))", neverDefault = true)
                        DirectCallNode callNode) {
            ClojureClosure cc = asClojureClosure(fn);
            return BytecodeInvoke.callDirect(callNode, new Object[]{cc.getCapturedFrame(), a0, a1, a2});
        }

        @Specialization(guards = "isPlainIFn(fn)")
        public static Object doIFn(Object fn, Object a0, Object a1, Object a2) {
            return BytecodeInvoke.invokeIFn((IFn) fn, a0, a1, a2);
        }

        @Specialization(replaces = {"doClojureClosure", "doIFn"})
        public static Object doOther(Object fn, Object a0, Object a1, Object a2) {
            return BytecodeInvoke.cannotCall(fn);
        }
    ...
    @Operation(storeBytecodeIndex = true)
    @com.oracle.truffle.api.bytecode.ConstantOperand(type = Object.class, name = "fn")
    public static final class InvokePinned4 {
        @Specialization(guards = "isClojureClosure(fn)")
        public static Object doClojureClosure(
                Object fn,
                Object a0,
                ...
                @com.oracle.truffle.api.dsl.Cached(value = "createCallNode(asClojureClosure(fn))", neverDefault = true)
                        DirectCallNode callNode) {
            ClojureClosure cc = asClojureClosure(fn);
            return BytecodeInvoke.callDirect(callNode, new Object[]{cc.getCapturedFrame(), a0, a1, a2, a3});
        }

        @Specialization(guards = "isPlainIFn(fn)")
        public static Object doIFn(Object fn, Object a0, Object a1, Object a2, Object a3) {
            return BytecodeInvoke.invokeIFn((IFn) fn, a0, a1, a2, a3);
        }

        @Specialization(replaces = {"doClojureClosure", "doIFn"})
        public static Object doOther(Object fn, Object a0, Object a1, Object a2, Object a3) {
            return BytecodeInvoke.cannotCall(fn);
        }
    ...
    @Operation(storeBytecodeIndex = true)
    @com.oracle.truffle.api.bytecode.ConstantOperand(type = Object.class, name = "fn")
    public static final class InvokePinnedN {
        @Specialization(guards = "isClojureClosure(fn)")
        public static Object doClojureClosure(
                Object fn,
                @Variadic Object[] args,
                @com.oracle.truffle.api.dsl.Cached(value = "createCallNode(asClojureClosure(fn))", neverDefault = true)
                        DirectCallNode callNode) {
            return BytecodeInvoke.callDirect(callNode, BytecodeInvokeVar.withCapturedFrame(asClojureClosure(fn), args));
        }

        @Specialization(guards = "isPlainIFn(fn)")
        public static Object doIFn(Object fn, @Variadic Object[] args) {
            return BytecodeInvoke.invokeIFnVariadic((IFn) fn, args);
        }

        @Specialization(replaces = {"doClojureClosure", "doIFn"})
        public static Object doOther(Object fn, @Variadic Object[] args) {
            return BytecodeInvoke.cannotCall(fn);
        }
