...
/**
 * PEA experiment V3 (bytes only): V2 plus a byte[]-only scanner with no TruffleString
 * dual-source branch in {@code sourceByte}/{@code sameBytes}. TruffleString input
 * falls back to {@link JsonScan} at the entry point.
 */
public final class JsonScanV3BytesOnly {

    private JsonScanV3BytesOnly() {
    }
