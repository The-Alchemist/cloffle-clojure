...
/**
 * PEA experiment V1 (cold errors): same scan as {@link JsonScan}, but {@code err}
 * is static and every throw site transfers to the interpreter first so PE can
 * prune error branches. Reuses {@link JsonScan}'s trie / result types.
 */
public final class JsonScanV1ColdError {

    private JsonScanV1ColdError() {
    }
