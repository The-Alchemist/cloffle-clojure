...
/**
 * Typed JSON projection for Truffle languages. String captures are UTF-8
 * {@link TruffleString} slices. This type is independent of {@code clojure.lang};
 * hosts such as Cloffle assemble language maps from {@link TypedScanResult} slots.
 */
public final class JsonScan {
    ...
    public static TypedScanResult projectString(String json, TypedTrieNode root, TypedLeaf[] leaves) {
    ...
    @TruffleBoundary
    public static TypedScanResult projectBytes(byte[] json, TypedTrieNode root, TypedLeaf[] leaves) {
    ...
    @TruffleBoundary
    public static TypedScanResult projectByteBuffer(ByteBuffer json, TypedTrieNode root, TypedLeaf[] leaves) {
    ...
    public static TypedScanResult projectBytes(byte[] json, int off, int len, TypedTrieNode root,
                                               TypedLeaf[] leaves, boolean firstWins) {
    ...
    public static TypedScanResult projectBytesPartialEvaluated(byte[] json, TypedTrieNode root,
                                                               TypedLeaf[] leaves, boolean firstWins) {
        if (json == null) {
            throw new NullPointerException("json");
        }
    ...
    @TruffleBoundary
    public static TypedScanResult projectTruffleString(TruffleString json, TypedTrieNode root,
                                                       TypedLeaf[] leaves, boolean firstWins) {
        if (json == null) {
            throw new NullPointerException("json");
        }
...
public static final class TypedLeaf {
    ...
    /**
     * Whatever the input holds. Schema leaves that do not name a JSON type use this kind.
     */
