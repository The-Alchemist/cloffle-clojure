...
public class ProtocolInvokeNode extends ClojureNode {
    ...
    public Object executeGeneric(VirtualFrame virtualFrame) {
        Object fn = ClojureInterop.unwrap(protocolFn.executeGeneric(virtualFrame));
        Object tgt = ClojureInterop.unwrap(target.executeGeneric(virtualFrame));
        ...
        if (fn instanceof IFn ifn) {
            ...
            return ClojureInterop.wrap(ifn.applyTo(clojure.lang.RT.seq(allArgs)));
        }
